  ...
  theme: {
    extend: {
      ...
      dropShadow: {
        ...
        "text-nd":"1px 2px 0px rgba(0, 0, 0, 0.90)",
        "text-lg":"1px 4px 0px rgba(0, 0, 0, 0.40)",
      },
      container:{
        center: true,
        padding: {
      ...
      fontSize: {
        ...
        lg: ["clamp(1.27rem, calc(1.03rem + 1.19vw), 1.887rem)", "1.4"],
        ...
        "16xl": ["clamp(5rem, calc(2rem + 15vw), 16rem)", "1"],
      },      
    },
  },
  plugins: [],
